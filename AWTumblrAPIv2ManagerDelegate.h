...
-(void)tumblrAPIv2Manager:(AWTumblrAPIv2Manager *)manager didLikePostWithId:(NSNumber *)postId;
-(void)tumblrAPIv2Manager:(AWTumblrAPIv2Manager *)manager didUnlikePostWithId:(NSNumber *)postId;
-(void)tumblrAPIv2Manager:(AWTumblrAPIv2Manager *)manager didLoadBlogFollowersInfo:(NSDictionary *)blogFollowersInfo;
